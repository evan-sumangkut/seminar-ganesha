        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <ul class="nav">
              ...
              <li><a href="backoffice/pages/sign-in.php">Login</a></li> 
      ...
      <div class="row">
        ...
        <div class="col-lg-10 offset-lg-1">
          <ul class="categories">
            ...
            <li><a href="listing.php"><span class="icon"><img src="assets/images/search-icon-02.png" alt="Food"></span> Food &amp; Life</a></li>
